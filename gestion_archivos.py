...
def json_a_bin(archivo_json):
    ...
    print(f"✅ Archivo registros.bin generado con {len(registros)} registros.")
    ...
    try:
        ...
        with open("registros.txt", "w", encoding="utf-8") as f_txt:
            for registro in datos:
                ...
                f_txt.write("\n")
        eliminar_archivo(archivo_json)
        print(f"{color_rosa}✅ Archivo JSON convertido a TXT exitosamente.{reset_color}")
    except Exception as e:
...
def bin_a_json():
    ...
    print(f"✅ Archivo registros.json generado con {len(registros)} registros.")
...
def txt_a_json(archivo_txt, retornar_lista=False):
    ...
    try:
        ...
        print(f"{color_rosa}✅ Archivo TXT convertido a JSON exitosamente.{reset_color}")
...
def txt_a_bin(archivo_txt):
    ...
    try:
        ...
        print(f"{color_rosa}✅ Archivo TXT convertido a BIN exitosamente (reutilizando funciones).{reset_color}")
